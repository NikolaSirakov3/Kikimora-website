...
export function MediaContactSection() {
  return (
    <section className="flex flex-col items-center justify-center py-12 w-full">
      ...
      <div className="bg-blue-50 rounded-xl shadow-sm px-8 py-10 max-w-5xl w-full flex flex-col items-center">
        ...
        <div className="space-y-2 text-center mb-6">
          <div>
            ...
            <a
              ...
              className="text-blue-700 underline focus:outline-none focus:ring-2 focus:ring-blue-400"
        ...
        <button
          className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors"
          type="button"
